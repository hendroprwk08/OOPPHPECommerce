...
function pilih( idbrg, nama, berat, harga){
	...
	window.opener.document.pembelian.hargabeli.value = harga;
	window.close();
}
</script>
</head>
	...
	$view .= "<table class='tablist' width='100%'>";			 
			...
			foreach  ($obj->viewdata($sql) as $res){	
				$view.="<tr>
								...
								<td width='12%'><a href='#' class='currpage' onclick=\"return pilih('".$res[0]."', '".$res[2]."', '".$res[11]."', '".$res[5]."')\">Pilih</a></td>
							</tr>";
			}
